...
import styles from './TradeLoan.module.scss'
...
// Данные для истории займов XAU (поменяли местами с PaxG)
	...
	return (
		<div className={styles.container}>
			...
			<div className={styles.loanHistorySection}>
				<div>
					<h3 className={styles.loanHistoryTitle}>История займов XAU Trade</h3>
					<div className={styles.gradientLine}></div>
				</div>
				<div className={styles.loanHistoryWrapper}>
					<LoanHistory
						data={activeCrypto === 'xaut' ? loanHistoryData : []}
						isEmpty={activeCrypto === 'paxg'}
					/>
				</div>
			</div>
		</div>
